...
<html lang="en">
    ...
    <head>
        ...
        ======================================================= -->
    </head>                        <% Categorie[]cor=(Categorie[])request.getAttribute("categorie");%>
   ...
   <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="delCat<%=cor[i].getId()%>" class="modal fade">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">                  <form action="delCat" method="get">
                                    ...
                                    <table style="width:80%" border="1" class="table table-striped table-responsive-md">
                                        ...
                                        <td><%=cor[i].getNom()%></td>
                                                ...
                                                <td><a data-toggle="modal" href="#newCat"> 
                                                    ...
                                                    <a data-toggle="modal" href="#delCat<%=cor[i].getId()%>">  <button class="btn btn-danger btn-xs"><i class="fa fa-trash-o ">Del</i></button>
                                                </td>
                                            </tr>
                                            <%
                                            } 
